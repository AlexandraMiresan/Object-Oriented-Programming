...
public:
    ...
    void setupUi(QWidget *GUIDesigner)
    {
        ...
        GUIDesigner->resize(1134, 684);
        QIcon icon(QIcon::fromTheme(QIcon::ThemeIcon::MediaTape));
        GUIDesigner->setWindowIcon(icon);
...
"font: 9pt \"Segoe UI\";"));
        ...
        undoButton->setGeometry(QRect(790, 520, 311, 24));
        undoButton->setStyleSheet(QString::fromUtf8("color:black; background-color:white"));
        line_3 = new QFrame(Admin);
        line_3->setObjectName("line_3");
        line_3->setGeometry(QRect(780, 500, 331, 16));
        line_3->setFrameShape(QFrame::Shape::HLine);
        line_3->setFrameShadow(QFrame::Shadow::Sunken);
        redoButton = new QPushButton(Admin);
        redoButton->setObjectName("redoButton");
        redoButton->setGeometry(QRect(790, 550, 311, 24));
        redoButton->setStyleSheet(QString::fromUtf8("color:black; background-color:white"));
        QIcon icon1(QIcon::fromTheme(QIcon::ThemeIcon::InputKeyboard));
        TabWidget->addTab(Admin, icon1, QString());
        User = new QWidget();
        User->setObjectName("User");
        displayList = new QListWidget(User);
        displayList->setObjectName("displayList");
        displayList->setGeometry(QRect(770, 250, 331, 131));
        displayList->setStyleSheet(QString::fromUtf8("background-color:white"));
        nextButton = new QPushButton(User);
        nextButton->setObjectName("nextButton");
        nextButton->setGeometry(QRect(770, 400, 221, 21));
        nextButton->setStyleSheet(QString::fromUtf8("background-color: white;"));
        checkBox = new QCheckBox(User);
        checkBox->setObjectName("checkBox");
        checkBox->setGeometry(QRect(1000, 390, 91, 31));
        openLinkButton = new QPushButton(User);
        openLinkButton->setObjectName("openLinkButton");
        openLinkButton->setGeometry(QRect(770, 430, 131, 24));
        openLinkButton->setStyleSheet(QString::fromUtf8("background-color:white;"));
        removeButton = new QPushButton(User);
        removeButton->setObjectName("removeButton");
        removeButton->setGeometry(QRect(910, 430, 191, 24));
        ...
        openApp->setGeometry(QRect(770, 200, 331, 24));
        openApp->setStyleSheet(QString::fromUtf8("background-color:white"));
        saveButton = new QPushButton(User);
        saveButton->setObjectName("saveButton");
        saveButton->setGeometry(QRect(770, 160, 331, 24));
        saveButton->setStyleSheet(QString::fromUtf8("background-color:white"));
        tableView = new QTableView(User);
        tableView->setObjectName("tableView");
        tableView->setGeometry(QRect(40, 90, 721, 471));
        tableView->setStyleSheet(QString::fromUtf8("background-color:white; color:black"));
        QIcon icon2(QIcon::fromTheme(QIcon::ThemeIcon::AudioCard));
        TabWidget->addTab(User, icon2, QString());
    ...
    void retranslateUi(QWidget *GUIDesigner)
    {
        ...
        undoButton->setText(QCoreApplication::translate("GUIDesigner", "UNDO", nullptr));
        redoButton->setText(QCoreApplication::translate("GUIDesigner", "REDO", nullptr));
